...
// Source: github.com/HuyDangDev/simplebank/db/sqlc (interfaces: Store)
...
// CreateTranfers mocks base method.
func (m *MockStore) CreateTranfers(arg0 context.Context, arg1 db.CreateTranfersParams) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTranfers", arg0, arg1)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateTranfers indicates an expected call of CreateTranfers.
func (mr *MockStoreMockRecorder) CreateTranfers(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTranfers", reflect.TypeOf((*MockStore)(nil).CreateTranfers), arg0, arg1)
}
